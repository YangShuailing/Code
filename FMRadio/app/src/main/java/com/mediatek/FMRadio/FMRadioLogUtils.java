...
public class FMRadioLogUtils {
    private static final boolean FMRADIO_XLOG_ON = true;
    //private static final boolean FMRADIO_XLOG_ON = false;
    
    public static int v(String tag, String msg) {
        int result;
        if (true == FMRADIO_XLOG_ON ) {
